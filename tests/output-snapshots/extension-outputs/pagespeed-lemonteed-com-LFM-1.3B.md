...
## 2. Core Web Vitals
- **LCP (Largest Contentful Paint)**: Mobile 4.49s 🔴 | Desktop 1.17s 🟢
- **CLS (Cumulative Layout Shift)**: Mobile 0.000 🟢 | Desktop 0.002 🟢
- **FCP (First Contentful Paint)**: Mobile 2.44s 🟡 | Desktop 0.24s 🟢
- **TBT (Total Blocking Time)**: Mobile 0.07s 🟢 | Desktop 0.12s 🟢
...
### 1. Reduce unused JavaScript
**Impact**: High (99) | **Category**: performance | **Affected**: mobile + desktop
**Measured**: Est savings of 63 KiB


**Concrete items from the audit (top offenders):**
1. https://www.googletagmanager.com/gtag/js?id=G-CCB0LW648K — wasted ~63 KiB
...
**Concrete items from the audit (top offenders):**
1. https://lemonteed.com/assets/css/style.css?v=9 — potential savings ~189ms — 11 KiB
2. https://lemonteed.com/assets/css/world-map.css?v=2 — potential savings ~561ms — 5 KiB
...
**Impact**: Medium (62) | **Category**: performance | **Affected**: mobile + desktop
**Measured**: 4.5 s
